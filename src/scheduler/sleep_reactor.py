    ...
    async def tick(self) -> None:
        try:
            ...
            prompt = (
                ...
                "⚠️ КРИТИЧНО: если в контексте сказано «КОРОТКИЙ дневной "
                "сон» / «шортнап» — НЕ ПИШИ «отлично выспался», «хорошо "
                "отдохнул», «классно поспал». Это ложь и сбивает Марину. "
                "Честно: «короткий сон, недоспал — сократим следующее "
                "окно бодрствования». Если длинный — отметь это тоже. "
                "Если в норме — можно похвалить.\n\n"
                "Не цитируй её сообщение. Можно одну деталь про прошлый "
                "план («как собирались» / «короче чем целились»)."
            )
            try:
