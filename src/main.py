...
_ACTION_HINTS = [
    ...
    "поправь", "почини", "пингуй", "обнови",
    # tool/feature requests to devops
    "нужен tool", "нет инструмента", "добавь функцию", "добавить функцию",
    "добавь tool", "реализуй", "напиши код", "нет такой функции",
    "не умею", "не могу", "нужна функция",
]
