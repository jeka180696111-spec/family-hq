...
class Parcel(Base):
    ...
    city_from: Mapped[str | None] = mapped_column(String, nullable=True)
    city_to: Mapped[str | None] = mapped_column(String, nullable=True)
    warehouse: Mapped[str | None] = mapped_column(String, nullable=True)
    weight_kg: Mapped[float | None] = mapped_column(Float, nullable=True)
    cost_uah: Mapped[float | None] = mapped_column(Float, nullable=True)
